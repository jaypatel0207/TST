...
import 'package:flutter_splash_screens/Search%20Funactionality/searchMovie_Using_API/profileMovie.dart';
...
class _MovieApiState extends State<MovieApi> {
  ...
  List<Map<String, dynamic>> movies = [
    ...
    },
    {
      ...
      "plot":
          "Eight years after the Joker's reign of anarchy, Batman is forced out of retirement to save Gotham City from the brutal guerrilla terrorist Bane.",
      "poster": "https://fakeimg.pl/220x310/f6f6f6",
    ...
    },
    {
      ...
      "poster": "https://fakeimg.pl/220x310/00ff00",
      "trailer": "https://example.com/jurassic_park_trailer.mp4",
      "runtime": 127,
      "awards": "Won 3 Oscars",
      "country": "USA",
      "language": "English",
      ...
      "website": "https://www.jurassicworld.com/jurassic-park"
    }
  ];

  List<Map<String, dynamic>> _foundMovie = [];
                        ...
                        child: Card(
                          ...
                          child: Padding(
                              ...
                              child: ListTile(
                                ...
                                title: Text(
                                  _foundMovie[index]["title"].toString(),
                                  style: TextStyle(
                                      fontSize: 18,
                                      fontWeight: FontWeight.bold),
                                ),
                                subtitle: Text(
                                  _foundMovie[index]["awards"].toString(),
                                  style: TextStyle(color: Colors.white),
                                ),
                              )),
                        ),
